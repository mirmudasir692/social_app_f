      ...
      <div class="flex flex-col">
        <div className="flex mx-auto">
          <p className="text-white mt-auto">
            {user && user.followers_num} followers
          </p>
          <img
          ...
          />
          <p className="text-white mt-auto">
            {user && user.following_num} following
          </p>
        </div>

        <div class="sm:w-[80%] xs:w-[90%] mx-auto flex">
          <h1 class="w-full text-left font-bold my-4 sm:mx-4 xs:pl-4 text-gray-800 dark:text-white lg:text-4xl md:text-3xl sm:text-3xl xs:text-xl text-4xl mb-10 flex justify-center max-sm:text-2xl max-sm:mb-2">
            {user && user.username}
          </h1>
        </div>

        <div class="xl:w-[80%] lg:w-[90%] md:w-[90%] sm:w-[92%] xs:w-[90%] mx-auto flex flex-col gap-4 items-center relative lg:-top-8 md:-top-6 sm:-top-4 xs:-top-4 max-w-1/2">
          <div class="w-full my-auto py-6 flex flex-col justify-center gap-2">
            ...
            <button
              onClick={() => logout_user_handler()}
              className="bg-white py-1 mx-auto font-black text-xl px-5 rounded-md hover:bg-slate-600 hover:text-white hover:border hover:border-b"
            >
              logout
            </button>
          </div>
